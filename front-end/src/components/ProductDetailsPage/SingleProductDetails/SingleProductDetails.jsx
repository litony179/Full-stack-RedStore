                ...
                <div className=" col-2">
                    ...
                    <div className="small-PD-img-row">
                        <div className="small-PD-img-col">
                            <img onClick={() => setPDImageShown(PD.PDImage1)} src={details.imagePD1} alt={details.name} width="100%" />
                        </div>
                        <div className="small-PD-img-col">
                            <img onClick={() => setPDImageShown(PD.PDImage2)} src={details.imagePD2} alt={details.name} width="100%" />
                        </div>
                        <div className="small-PD-img-col">
                            <img onClick={() => setPDImageShown(PD.PDImage3)} src={details.imagePD3} alt={details.name} width="100%" />
                        </div>
                        <div className="small-PD-img-col">
                            <img onClick={() => setPDImageShown(PD.PDImage4)} src={details.imagePD4} alt={details.name} width="100%" />
                        </div>
                    </div>
                </div>
                <div className="col-2">
                    ...
                    <a href="" className="btn singleProductDetails-btn">Add To Cart</a>
